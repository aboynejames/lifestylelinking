...
class LLassumptions
{
   ...
   public function __construct()
		{
			$this->assumptions['remove'] = array("'", "-", ",", "(",")", "?", ".", "&rsquo;", "&ldquo;", "&rsquo;", "&rdquo;", ":", "@", "!", "#",  "^", "%", "/", "|", '\'', "+", "=", "{", "}", "[", "]", '"', ";", "*", "<", ">", "_", "~", "<br />", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "also", "www", "jpg", "org", "html", "http", "–", "com" );
      $this->assumptions['wordlength'] = 0;
      $this->assumptions['characterperwordmax'] = 30;
      $this->assumptions['numberwisewords'] = 50;
      $this->assumptions['numbercontentwords'] = 50;
